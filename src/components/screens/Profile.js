        ...
        <div className="profile-block">
          ...
          <div className="file-path-wrapper">
            ...
            <div className="follow-desc">
              <div className="posts"><b>{photos.length}</b> Posts</div>
              <div className="followers"><b>{state ? state.followers.length : "0"}</b> Followers</div>
              <div className="following"><b>{state ? state.following.length : "0"}</b> Following</div>
            </div>
          </div>
        </div>
